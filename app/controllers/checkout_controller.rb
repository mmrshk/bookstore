class CheckoutController < ApplicationController
  ...
  def show
    ...
    step == :login ? login : @addresses = ShowCheckoutService.new(current_user, current_order, step).call
    render_wizard
  end
  ...
  def update_addresses
    @addresses = AddressesForm.new(current_order, addresses_params)
    UpdateParamsCheckoutService.update_addresses(current_order)
    render_wizard(@addresses)
  end
