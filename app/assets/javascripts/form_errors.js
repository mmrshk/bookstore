$(document).ready(function(){
  if ($('#billing_form div div').hasClass('form-group-invalid') || $('#shipping_form div div').hasClass('form-group-invalid') || $('#address_form div div').hasClass('form-group-invalid')) {
